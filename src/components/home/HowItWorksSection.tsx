        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
          ...
          {HOW_IT_WORKS_STEPS.map(({ num, title, desc }) => (
            <div key={num} className="relative z-10 flex flex-col items-center text-center group">
              <div className="w-16 h-16 rounded-full bg-luxury-card border border-neon-pink/30 flex items-center justify-center mb-6 group-hover:border-neon-pink group-hover:shadow-glow-pink transition-all duration-300">
