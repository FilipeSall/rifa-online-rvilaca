...
export default function HeroSection() {
  ...
  const countdownItems = [
    { value: formatUnit(countdown.days), label: 'Dias' },
    { value: formatUnit(countdown.hours), label: 'Horas' },
    { value: formatUnit(countdown.minutes), label: 'Min' },
    { value: formatUnit(countdown.seconds), label: 'Seg' },
  ]
